...
plot(p_grid, prior, xlab="probability of a teacher giving a correct answer", ylab="prior probability")
mtext("Prior")
...
plot(p_grid, prior, xlab="probability of a teacher giving a correct answer", ylab="prior probability")
mtext("Skeptic random chance prior")
plot(p_grid, posterior, type="b", xlab="probability of Josh giving a correct answer", ylab="posterior probability")
mtext("Posterior with a skeptic prior")
